...
<head>
    ...
    <!-- Website Title -->
    <title>RWCS - Remote Work Chat System</title>
...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="#request">Ask Question</a>
                </li>
                ...
                <!-- end of dropdown menu -->
                                ...
                                <!-- Dropdown Menu -->
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle page-scroll"  id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false">Choose Language</a>
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="/register"><span class="item-text">For Register</span></a>
                        <div class="dropdown-items-divide-hr"></div>
                        <a class="dropdown-item" href="/login"><span class="item-text">For Login</span></a>
                    </div>
                </li>
            </ul>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="text-container">
                            <h1><span class="turquoise">Computer Science And Engineering</span>  Department</h1>
                            <p class="p-large">Remote Work Chat System</p>
                            <a class="btn-solid-lg page-scroll" href="#info">About This Website</a>
    ...
    <div id="services" class="cards-1">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2>Our Services</h2>
                    <p class="p-heading p-large">Our services are listed below for small and medium companies in all government and related industries</p>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>Simply contact them from your workplace and send them a message</p>
                        </div>
                    </div>
                    <!-- end of card -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Local contact system</h4>
                            <p>You can connect in a video chat at home with low bandwidth</p>
                        </div>
                    </div>
                    <!-- end of card -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>One of the good things you can do to contact a sender file or receive a file is a meeting with administrators at the meeting place.</p>
                        </div>
                    </div>
                    <!-- end of card -->
    ...
    <div class="basic-1">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="text-container">
                        <h2>Design and plan for the growth stages of your business</h2>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="team-member">
                        ...
                        <p class="p-large"><strong>Mr. X</strong></p>
                    ...
                    <div class="team-member">
                        ...
                        <p class="p-large"><strong>Mr. Y</strong></p>
                    ...
                    <div class="team-member">
                        ...
                        <p class="p-large"><strong> Miss. X</strong></p>
                    ...
                    <div class="team-member">
                        ...
                        <p class="p-large"><strong> Miss. Y</strong></p>
                    ...
                    <div class="footer-col middle">
                        ...
                        <ul class="list-unstyled li-space-lg">
                            <li class="media">
                                ...
                                <div class="media-body">Our business partners <a class="turquoise" href="#your-link">http://samsonnegash.me</a></div>
                            </li>
                            <li class="media">
                                <i class="fas fa-square"></i>
 ...
 <div class="pubble-app" data-app-id="85744" data-app-identifier="85744"></div>
 <script type="text/javascript" src="https://cdn.chatify.com/javascript/loader.js" defer></script>
    ...
    <script src="https://apps.elfsight.com/p/platform.js" defer></script>
    <div class="elfsight-app-0087636e-054d-4c65-9e84-2bcdaa48e135"></div>
