                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="button.html">Work On Your Home</a>
                                </li>
                                <li>
                                    <a href="badge.html">Work Inside Workplace(No Internet Needed)</a>
                                </li>
                                <li>
                                    <a href="tab.html">Specific Group Chat</a>
                                </li>
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="button.html">Live On Your Home</a>
                                </li>
                                <li>
