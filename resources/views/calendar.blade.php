            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-comments"></i>Work Online</a>
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="chats">Work On Your Home</a>
                                </li>
                                <li>
                                    <a href="chats">Work Inside Workplace(No Internet Needed)</a>
                                </li>
                                <li>
                                    <a href="chats">Specific Group Chat</a>
                                </li>
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="RWCSvideo">Live On Your Home</a>
                                </li>
                                <li>
                                    <a href="RWCSvideo">Live Inside Workplace(No Internet Needed)</a>
                                </li>
                        ...
                        <li>
                            <a href="calendar" style="color: red">
                                <i class="fas fa-calendar-alt"></i>Calendar</a>
                        </li>
